...
// Water Features 
#water {
  // JO: on met une couleur noire
  polygon-fill: #000;
  
  // JO: on enleve le pattern
...
#landuse[zoom>=11] {
  [class='park'], [class='cemetery'] { 
    ...
    //polygon-opacity: 0.45;
     // JO: on enleve le gris et on fait des points
    polygon-pattern-file: url('img/patterns/halftone2BIG.png');
    polygon-pattern-alignment: global;
...
*/
/*
// on enleve les labels de contour
#contour.label {
    text-name: "[ele]+' m'";
    text-face-name: @sans;
    text-placement: line;
