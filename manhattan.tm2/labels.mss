...
@serif_it: 'Meta Serif Offc Pro Regular', @fallback;
//sans
...
@sans_it: 'Meta Offc Pro Normal', @fallback;
@sans_it_md: 'Meta Offc Pro Medium', @fallback;
@sans_it_bd: 'Meta Offc Pro Bold', @fallback;
